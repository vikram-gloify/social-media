...
const MainFeedCardThree = () => {
    return (
        <div className="card">
            <div className="card-header bg-white pt-3 border-0 pb-0">
                <div className="d-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center">
                        ...
                        <div>
                            <h6 className="card-title mb-0"> <a href="/" className="text-decoration-none lori-ferguson"> All in the Mind </a></h6>
                            <p className="mb-0 small">9 November at 23:29</p>
                        </div>
                    </div>
                    <a href="/" className="text-secondary btn three-dots py-1 px-2" id="cardShareAction10" data-bs-toggle="dropdown" aria-expanded="false">
