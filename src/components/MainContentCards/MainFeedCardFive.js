...
const MainFeedCardFive = () => {
    return (
        <div className="card">
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <div>
                            <div className="nav nav-divider">
                                <h6 className="nav-item card-title mb-0"> <a href="/" className="text-decoration-none"> Joan Wallace </a></h6>
            ...
            <video className="overflow-hidden fullscreen-video w-100" controls>
                            ...
                            <div className="ms-2">
                                ...
                                <div className="bg-light rounded-start-top-0 p-3 rounded">
                                    <div className="d-flex justify-content-between">
                                        <h6 className="mb-1"> <a href="/" className="text-decoration-none lori"> Frances Guerrero </a></h6>
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="ms-2">
                                        <div className="bg-light p-3 rounded">
                                            <div className="d-flex justify-content-between">
                                                <h6 className="mb-1"> <a href="/" className="text-decoration-none lori"> Lori Stevens </a> </h6>
