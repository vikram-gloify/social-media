        ...
        <div className="card">
            ...
            <div className="card-body">
                ...
                <ul className="nav nav-stack py-3 small">
                    ...
                    <li className="nav-item">
                        <a className="nav-link comment" href="/"> <i className="bi bi-chat-fill pe-1"></i>Comments (12)</a>
                    </li>

                    <li className="nav-item dropdown ms-sm-auto">
                        <a className="nav-link mb-0 share" href="/" id="cardShareAction" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div className="d-flex position-relative">
                            ...
                            <div className="ms-2">
                                ...
                                <ul className="nav nav-divider py-2 small">
                                    <li className="nav-item">
                                        <a className="nav-link like" href="/" > Like (3)</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link like" href="/"> Reply</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link like" href="/" > View 5 replies</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <li className="comment-item">
                                <div className="d-flex">
                                    ...
                                    <div className="ms-2">
                                        ...
                                        <ul className="nav nav-divider py-2 small">
                                            <li className="nav-item">
                                                <a className="nav-link like" href="/"> Like (5)</a>
                                            </li>
                                            <li className="nav-item">
                                                <a className="nav-link like" href="/"> Reply</a>
                                            </li>
                            ...
                            <li className="comment-item">
                                <div className="d-flex">
                                    ...
                                    <div className="avatar avatar-story avatar-xs">
                                        <a href="/"><img className="avatar-img rounded-circle" src={Avatar} alt="" /></a>
                                    </div>
                                    ...
                                    <div className="ms-2">
                                        ...
                                        <ul className="nav nav-divider py-2 small">
                                            <li className="nav-item">
                                                <a className="nav-link like" href="/"> Like</a>
                                            </li>
                                            <li className="nav-item">
                                                <a className="nav-link like" href="/"> Reply</a>
                                            </li>
