...
const MainContentCardTwo = () => {
    return (
        <div className="card">
            <div className="card-header bg-white bootstrap-header">
                <div className="d-flex align-items-center mb-2 mt-2 justify-content-between">
                    <div className="d-flex align-items-center">
                        <div className="avatar me-2">
                            <a href="/">
                                <img className="feed-news-img rounded-circle bootstrap-icon" src={bootstrap} alt="bootstrap" />
                            </a>
                        </div>
                        <div>
                            <h6 className="card-title mb-0"><a href="/" className="bootstrap-a lori-ferguson text-decoration-none"> Bootstrap: Front-end framework </a></h6>
                            <a href="/" className="mb-0 text-body text-decoration-none sponsored">Sponsored <i className="bi bi-info-circle ps-1 sponsored" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="You're seeing this ad because your activity meets the intended audience of our site." data-bs-original-title="" title=""></i> </a>
                        </div>
                    </div>
                    <div className="dropdown">
                        <a href="/" className="text-secondary btn three-dots py-1 px-2" id="cardShareAction2" data-bs-toggle="dropdown" aria-expanded="false">
